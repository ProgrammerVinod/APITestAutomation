...
public class FileHandlingUtils {
	static Logger LOGGER = Logger.getLogger(FileHandlingUtils.class);
	...
	public static boolean deleteDirectory(String folderPath) {
		...
		LOGGER.error("Supplied path " + folderPath + " is not a valid directory");
		return false;
	}
	...
	private static void zipIt(String sourcePath, String zipFileName) {
		String source = "";
